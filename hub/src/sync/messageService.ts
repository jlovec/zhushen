...
import { buildNewMessageUpdate } from '@zs/protocol'
import type { AttachmentMetadata, DecryptedMessage } from '@zs/protocol/types'
...
export class MessageService {
    ...
    async sendMessage(
        ...
        const content = buildCanonicalUserMessage({
            text: payload.text,
